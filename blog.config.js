...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || 'ad0ba51a746d412195b4452671e03ab5',
      PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
      NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
      THEME: process.env.NEXT_PUBLIC_THEME || '00mine', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
      ...
      GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '芥末味汽水儿',

      CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'mustardovo', // 您的昵称 例如 tangly1024
      BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人', // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-roan-psi-96.vercel.app', // 网站地址
      KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

      // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mustardovo@gmail.com', // 邮箱地址 例如mail@tangly1024.com
      CONTACT_BEHANCE: process.env.NEXT_PUBLIC_CONTACT_BEHANCE || 'https://www.behance.net/MustardOvO', // behance
      CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/mustardOvO', // 你的twitter个人主页
      ...
      FONT_AWESOME: process.env.NEXT_PUBLIC_FONT_AWESOME_PATH || '//at.alicdn.com/t/c/font_4484813_j9uccjv75ig.css',
      // END ************网站字体*****************
      ...
      TITLE: process.env.NEXT_PUBLIC_TITLE || 'MustardOvO', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
      HOME_BANNER_IMAGE:
